    ...
    <div class="container">
        ...
        <nav class="navbar" style="background: #2f375b;">
            <ul>
                ...
                <li style="margin-top: 30px; text-decoration: underline;"><a href="#service">Tour Packages</a></li>
        ...
        <!-- make reservation popup window -->
         ...
         <!-- end of guide info -->
            ...
            <img src="img/packages/1.jpg" style="width:640px; height:380px">
            
            </div>

            <div class="mySlides fade">
            
            <img src="img/packages/2.jpg" style="width:640px ;height:380px">
            
            </div>

            <div class="mySlides fade">
            
            <img src="img/packages/3.jpg" style="width:640px ;height:380px">
            
            </div>

            <div class="mySlides fade">
            
            <img src="img/packages/4.jpg" style="width:640px ;height:380px">
