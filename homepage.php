...
<body>
    <div class="container">
        ...
        <section id="tourPackage">
            ...
            <button class="loginbutton" style="width: 300px; margin-left: 800px; margin-top: 10px; font-size: 1.25rem; height: 70px; "><span>Explore Tour Packages</span></button>
        ...
        <section id="smartSearch">
            ...
            <button class="loginbutton" style="width: 250px; margin-left: 900px; margin-top: 10px; font-size: 1.25rem; height: 70px; "><span>Smart Search</span></button>
